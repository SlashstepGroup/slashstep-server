DO $$
  BEGIN
    ...
    CREATE TABLE IF NOT EXISTS action_log_entries (
      ...
      target_delegation_policy_id UUID,
      target_field_id UUID,
      target_field_choice_id UUID,
      target_field_value_id UUID,
      target_group_id UUID,
      target_http_transaction_id UUID,
      target_item_id UUID,
      target_item_connection_id UUID,
      target_item_connection_type_id UUID,
      target_item_type_id UUID,
      target_item_type_field_id UUID,
      target_item_type_icon_id UUID,
      target_iteration_id UUID,
      target_membership_id UUID,
      target_membership_invitation_id UUID,
