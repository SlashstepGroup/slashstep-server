...
pub const GET_RESOURCE_ACTION_NAME: &str = "slashstep.projects.get";
...
impl Project {
  ...
  /// Creates a new field.
  pub async fn create(initial_properties: &InitialProjectProperties, database_pool: &deadpool_postgres::Pool) -> Result<Self, ResourceError> {
