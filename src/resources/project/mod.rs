...
pub const UUID_QUERY_KEYS: &[&str] = &["id", "parent_workspace_id"];
pub const RESOURCE_NAME: &str = "Project";
pub const DATABASE_TABLE_NAME: &str = "projects";
pub const GET_RESOURCE_ACTION_NAME: &str = "projects.get";

#[derive(Debug, Clone, PartialEq, Eq, Default)]
pub struct InitialProjectProperties {
    /// The project's name.
    pub name: String,
...
impl Project {
    ...
    pub async fn get_by_id(
        ...
        let database_client = database_pool.get().await?;
        let query = include_str!("../../queries/projects/get_project_row_by_id.sql");
    ...
    pub async fn create(
        ...
        let query = include_str!("../../queries/projects/insert_project_row.sql");
    ...
    pub async fn update(
        &self,
        properties: &EditableProjectProperties,
        database_pool: &deadpool_postgres::Pool,
    ) -> Result<Self, ResourceError> {
        ...
        let (parameter_boxes, query) = slashstepql::add_parameter_to_query(
            ...
            query,
            "start_date",
            properties.start_date.as_ref(),
        );
        let (parameter_boxes, query) = slashstepql::add_parameter_to_query(
            parameter_boxes,
            query,
            "end_date",
            properties.end_date.as_ref(),
        );
