/**
 * 
 * This module defines the implementation and types of a membership invitation.
 * 
 * Programmers: 
...
use crate::{resources::{ResourceError, access_policy::AccessPolicyPrincipalType, membership::{MembershipParentResourceType, MembershipPrincipalType}}, utilities::slashstepql::{self, SlashstepQLError, SlashstepQLFilterSanitizer, SlashstepQLParsedParameter, SlashstepQLSanitizeFunctionOptions}};
