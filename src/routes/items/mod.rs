...
async fn handle_list_items_request(
  ...
  let response = list_resources(
    ...
    None, 
    |query, database_pool, individual_principal| Box::new(Item::count(query, database_pool, individual_principal)),
    |query, database_pool, individual_principal| Box::new(Item::list(query, database_pool, individual_principal)),
    "items.list", 
