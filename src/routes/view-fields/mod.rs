...
async fn handle_list_view_fields_request(
    ...
    info!("Successfully returned {} {}.", queried_view_field_list_length, if queried_view_field_list_length == 1 { "view field" } else { "view fields" });
...
pub fn get_router(state: AppState) -> Router<AppState> {
    Router::<AppState>::new()
        .route(
            "/view-fields",
            axum::routing::get(handle_list_view_fields_request),
        )
