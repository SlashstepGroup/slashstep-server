...
pub fn get_router(state: AppState) -> Router<AppState> {
    ...
    Router::<AppState>::new()
        .route(
            "/view-fields/{view_field_id}",
            axum::routing::get(handle_get_view_field_request),
        )
        .route(
            "/view-fields/{view_field_id}",
            axum::routing::delete(handle_delete_view_field_request),
        )
        .route(
            "/view-fields/{view_field_id}",
            axum::routing::patch(handle_patch_view_field_request),
        )
