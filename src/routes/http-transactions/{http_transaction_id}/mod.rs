...
use crate::{
    ...
    utilities::route_handler_utilities::{
        get_action_by_name, get_action_log_entry_expiration_timestamp, get_http_transaction_by_id,
...
pub fn get_router(state: AppState) -> Router<AppState> {
    ...
    Router::<AppState>::new()
        .route(
            "/http-transactions/{http_transaction_id}",
            axum::routing::get(handle_get_http_transaction_request),
        )
        .route(
            "/http-transactions/{http_transaction_id}",
            axum::routing::delete(handle_delete_http_transaction_request),
        )
