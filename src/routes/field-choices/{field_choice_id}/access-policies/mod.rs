use crate::{
    ...
    utilities::route_handler_utilities::{
        ...
        get_field_choice_by_id, get_principal_type_and_id_from_principal,
...
async fn handle_list_access_policies_request(
    ...
    let field_choice = get_field_choice_by_id(&field_choice_id, &state.database_pool).await?;
...
async fn handle_create_access_policy_request(
    ...
    trace!(
        "Creating access policy for field choice {}...",
        field_choice_id
    );
...
pub fn get_router(state: AppState) -> Router<AppState> {
    Router::<AppState>::new()
        .route(
            "/field-choices/{field_choice_id}/access-policies",
