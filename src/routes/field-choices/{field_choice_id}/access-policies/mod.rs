...
async fn handle_list_access_policies_request(
  ...
  let resource_hierarchy = get_resource_hierarchy(&field_choice, &AccessPolicyResourceType::FieldChoice, &field_choice_id, &http_transaction, &state.database_pool).await?;
