...
use crate::{
    ...
    utilities::route_handler_utilities::{
        get_action_by_name, get_action_log_entry_expiration_timestamp, get_field_choice_by_id,
...
pub fn get_router(state: AppState) -> Router<AppState> {
    Router::<AppState>::new()
        .route(
            "/field-choices/{field_choice_id}",
            axum::routing::get(handle_get_field_choice_request),
        )
        .route(
            "/field-choices/{field_choice_id}",
            axum::routing::delete(handle_delete_field_choice_request),
        )
        .route(
            "/field-choices/{field_choice_id}",
            axum::routing::patch(handle_patch_field_choice_request),
        )
