...
use crate::{
  ...
  utilities::{reusable_route_handlers::delete_resource, route_handler_utilities::{AuthenticatedPrincipal, get_action_by_name, get_action_log_entry_expiration_timestamp, get_app_by_id, get_authenticated_principal, get_project_by_id, get_resource_hierarchy, get_uuid_from_string, verify_delegate_permissions, verify_principal_permissions}}
};
...
async fn handle_get_project_request(
  ...
  ActionLogEntry::create(&InitialActionLogEntryProperties {
    ...
    target_resource_type: ActionLogEntryTargetResourceType::Project,
