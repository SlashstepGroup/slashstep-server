...
use crate::{
    ...
    resources::{
        ...
        role::{
            DEFAULT_MAXIMUM_RESOURCE_LIST_LIMIT, InitialRoleProperties,
            InitialRolePropertiesWithPredefinedParent, Role, RoleParentResourceType,
        },
...
async fn handle_create_role_request(
    ...
    .await?;
    validate_field_length(
        &role_properties_json.display_name,
...
pub fn get_router(state: AppState) -> Router<AppState> {
    Router::<AppState>::new()
        .route(
            ...
            axum::routing::get(handle_list_roles_request),
        )
        .route(
            "/workspaces/{workspace_id}/roles",
            axum::routing::post(handle_create_role_request),
        )
