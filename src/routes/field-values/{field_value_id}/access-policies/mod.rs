...
async fn handle_list_access_policies_request(
  ...
  let resource_hierarchy = get_resource_hierarchy(&field_value, &AccessPolicyResourceType::FieldValue, &field_value_id, &http_transaction, &state.database_pool).await?;
