use crate::{
    ...
    utilities::route_handler_utilities::{
        ...
        get_item_type_icon_by_id, get_principal_type_and_id_from_principal,
...
async fn handle_list_access_policies_request(
    ...
    let item_type_icon = get_item_type_icon_by_id(&item_type_icon_id, &state.database_pool).await?;
...
pub fn get_router(state: AppState) -> Router<AppState> {
    Router::<AppState>::new()
        .route(
            "/item-type-icons/{item_type_icon_id}/access-policies",
