...
use crate::{
    ...
    resources::{
        ...
        item_connection::{DEFAULT_MAXIMUM_RESOURCE_LIST_LIMIT, ItemConnection},
...
async fn handle_list_item_connections_request(
    ...
    info!("Successfully returned {} {}.", queried_item_connection_list_length, if queried_item_connection_list_length == 1 { "item connection" } else { "item connections" });
