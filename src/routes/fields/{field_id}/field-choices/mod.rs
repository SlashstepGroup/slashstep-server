...
use crate::{
    ...
    resources::{
        ResourceError, ResourceType, StakeholderType,
        ...
        field_choice::{
            DEFAULT_MAXIMUM_RESOURCE_LIST_LIMIT, FieldChoice, FieldChoiceType,
    ...
    utilities::route_handler_utilities::{
        ...
        match_slashstepql_error, validate_decimal_is_within_range, validate_field_length,
...
async fn handle_create_field_choice_request(
    ...
    let created_field_choice = match FieldChoice::create(
        &InitialFieldChoiceProperties {
            ...
            stakeholder_type: field_choice_properties_json.stakeholder_type,
...
pub fn get_router(state: AppState) -> Router<AppState> {
    Router::<AppState>::new()
        .route(
            "/fields/{field_id}/field-choices",
            axum::routing::get(handle_list_field_choices_request),
        )
        .route(
            "/fields/{field_id}/field-choices",
            axum::routing::post(handle_create_field_choice_request),
        )
