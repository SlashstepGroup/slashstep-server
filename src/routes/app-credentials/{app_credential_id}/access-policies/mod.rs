use crate::{
    ...
    utilities::route_handler_utilities::{
        ...
        get_app_credential_by_id, get_principal_type_and_id_from_principal,
...
async fn handle_list_access_policies_request(
    ...
    let app_credential = get_app_credential_by_id(&app_credential_id, &state.database_pool).await?;
...
async fn handle_create_access_policy_request(
    ...
    trace!(
        "Creating access policy for app credential {}...",
        app_credential_id
    );
...
pub fn get_router(state: AppState) -> Router<AppState> {
    Router::<AppState>::new()
        .route(
            "/app-credentials/{app_credential_id}/access-policies",
