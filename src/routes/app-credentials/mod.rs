...
use crate::{
    ...
    resources::{
        ...
        app_credential::{AppCredential, DEFAULT_MAXIMUM_RESOURCE_LIST_LIMIT},
...
async fn handle_list_app_credentials_request(
    ...
    info!("Successfully returned {} {}.", queried_app_credential_list_length, if queried_app_credential_list_length == 1 { "app credential" } else { "app credentials" });
