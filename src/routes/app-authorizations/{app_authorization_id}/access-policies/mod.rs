...
async fn handle_list_access_policies_request(
  ...
  let resource_hierarchy = get_resource_hierarchy(&app_authorization, &AccessPolicyResourceType::AppAuthorization, &app_authorization_id, &http_transaction, &state.database_pool).await?;
