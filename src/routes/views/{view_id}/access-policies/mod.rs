use crate::{
    ...
    utilities::route_handler_utilities::{
        ...
        get_uuid_from_string, get_view_by_id, is_authenticated_user_anonymous, match_db_error,
...
async fn handle_create_access_policy_request(
    ...
    ServerLogEntry::trace(
        &format!("Creating access policy for view {}...", view_id),
        Some(&http_transaction.id),
        &state.database_pool,
    )
    .await
