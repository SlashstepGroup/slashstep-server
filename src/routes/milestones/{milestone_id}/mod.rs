use crate::{
    ...
    utilities::route_handler_utilities::{
        get_action_by_name, get_action_log_entry_expiration_timestamp, get_milestone_by_id,
...
pub fn get_router(state: AppState) -> Router<AppState> {
    Router::<AppState>::new()
        .route(
            ...
            axum::routing::get(handle_get_milestone_request),
        )
        .route(
            "/milestones/{milestone_id}",
            axum::routing::delete(handle_delete_milestone_request),
        )
        .route(
            "/milestones/{milestone_id}",
            axum::routing::patch(handle_patch_milestone_request),
        )
