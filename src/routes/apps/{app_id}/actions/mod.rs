...
async fn handle_list_actions_request(
  ...
  let queried_resources = match Action::list(&query, &state.database_pool, Some(&individual_principal)).await {
