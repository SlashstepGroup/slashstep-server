...
async fn handle_list_item_connection_types_request(
  ...
  let response = list_resources(
    ...
    None, 
    |query, database_pool, individual_principal| Box::new(ItemConnectionType::count(query, database_pool, individual_principal)),
    |query, database_pool, individual_principal| Box::new(ItemConnectionType::list(query, database_pool, individual_principal)),
