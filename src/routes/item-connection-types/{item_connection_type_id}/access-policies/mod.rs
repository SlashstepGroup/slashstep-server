...
async fn handle_list_access_policies_request(
  ...
  let resource_hierarchy = get_resource_hierarchy(&item_connection_type, &ResourceType::ItemConnectionType, &item_connection_type_id, &http_transaction, &state.database_pool).await?;
