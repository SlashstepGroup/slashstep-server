...
async fn handle_list_access_policies_request(
    ...
    .await?;
    let item_connection_type = get_item_connection_type_by_id(
        &item_connection_type_id,
        &http_transaction,
        &state.database_pool,
    )
...
async fn handle_create_access_policy_request(
    ...
    trace!("Creating access policy for item connection type {}...", item_connection_type_id);
...
pub fn get_router(state: AppState) -> Router<AppState> {
    Router::<AppState>::new()
        .route(
            "/item-connection-types/{item_connection_type_id}/access-policies",
