...
use crate::{
    ...
    resources::{
        ...
        status::{DEFAULT_MAXIMUM_RESOURCE_LIST_LIMIT, Status},
        user::User,
    },
...
async fn handle_list_statuses_request(
    ...
    info!("Successfully returned {} {}.", queried_status_list_length, if queried_status_list_length == 1 { "status" } else { "statuses" });
