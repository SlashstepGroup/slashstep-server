/*
 *
 * Any functionality for /session-credentials/{session_credential_id} should be handled here.
 *
 * Programmers:
...
use crate::{
    ...
    utilities::route_handler_utilities::{
        ...
        get_principal_type_and_id_from_principal, get_session_by_id, get_uuid_from_string,
...
/// GET /session-credentials/{session_id}
///
...
/// DELETE /session-credentials/{session_id}
///
...
pub fn get_router(state: AppState) -> Router<AppState> {
    Router::<AppState>::new()
        .route(
            ...
            axum::routing::get(handle_get_session_request),
        )
        .route(
            "/session-credentials/{session_id}",
            axum::routing::delete(handle_delete_session_request),
        )
