...
* A server running [PostgreSQL 18](https://www.postgresql.org/download/)

## Steps
### Step 2: Set up Slashstep Server through the console
From here, you can set up Slashstep Server through the console. 